...
export interface DocumentUploadResponse { document_id: string; encounter_id: string; document_type: string; entities_extracted: ExtractedEntitySummary[]; entity_count: number; }
